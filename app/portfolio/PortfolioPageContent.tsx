...
const projects = [
  ...
  {
    category: "אתרים",
    title: "Shopflexa | חנות איקומרס",
    description: "חנות אונליין מלאה עם עיצוב פרמיום, חוויית קנייה חלקה ומערכת ניהול מוצרים — בנויה להמרה.",
    result: "אתר חי ופעיל",
    gradient: "bg-gradient-to-br from-emerald-500/20 via-[#182845] to-[#182845]",
    image: "/web4ecom.png",
    href: "https://shopflexa.com",
    delay: 0.2,
    filter: "אתרים",
    typeLabel: "איקומרס",
    typeVariant: "ecom" as const,
  },
  {
    category: "דפי נחיתה",
